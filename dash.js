...
// PATCH: Security settings (autoDeleteDays removed)
let userSecuritySettings = {
  sessionTimeoutMinutes: null // session timeout value in minutes (null = not loaded)
};
...
// --- PRESETS SECTION PATCH (fully restored) ---
...
// --- PATCH: Security/Privacy Screen (autoDelete removed) ---
